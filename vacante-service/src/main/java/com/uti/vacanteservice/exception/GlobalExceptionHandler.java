package com.uti.vacanteservice.exception;
...
public class GlobalExceptionHandler {
    ...
    // 403 el reclutador intenta modificar una vacante que no es suya
